        ...
        <main className="flex flex-col flex-grow gap-4 items-start w-full">
          ...
          <section className="flex flex-col max-w-[450px] gap-8 items-start">
            <div className="flex flex-col justify-start">
              ...
              <div className="flex flex-col w-full">
                ...
                <p className="">
                  Live audio locater and transcription IoT system for HoH individuals. 
                </p>
              </div>
            </div>
            <div className="flex flex-col justify-start">
              ...
              <div className="flex flex-col w-full">
                ...
                <p className="">
                  Interactive command line interface application designed to simplify and accelerate Git merge conflict resolution. 
                </p>
              </div>
            </div>
          ...
          <div className="flex flex-col justify-start">
              ...
              <div className="flex flex-col w-full">
                ...
                <p className="">
                  2D platformer game where you can grab the objects out of your background, made for <span className="hover-bg">
            ...
            <div className="flex flex-col justify-start">
              ...
              <div className="flex flex-col w-full">
                ...
                <p className="">
                  Event website for Texas A&M’s beginner hackathon with a colorful skater twist!
                </p>
              </div>
            </div>
