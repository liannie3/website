          ...
          <main className="flex flex-col flex-grow gap-2 justify-center w-full">
            <section className="flex flex-col sm:flex-row gap-8 sm:gap-12 items-center">
              <div className="flex flex-col w-auto gap-4">
                <p className="">
                  Howdy! I’m Annie and I’m an undergraduate student studying electrical engineering at Texas A&M University. I’m interested in computer architecture (specifically the design & verification fields) and low-level systems, and I was a hardware intern at <span className="hover-bg">
                ...
                <p>
                  Outside of this I love drawing, playing the piano/guitar, single-player games and trying new coffee shops! 
                </p>
              </div>
              <Image
